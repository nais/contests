...
import (
	...
	_ "github.com/lib/pq"
	"github.com/nais/contests/pkg/kafka"
	log "github.com/sirupsen/logrus"
	flag "github.com/spf13/pflag"

	"github.com/nais/contests/pkg/bigquery"
	"github.com/nais/contests/pkg/bucket"
	"github.com/nais/contests/pkg/database"
	"github.com/nais/contests/pkg/metrics"
	"github.com/nais/contests/pkg/testable"
	"github.com/nais/contests/pkg/version"
)
...
func init() {
	...
	flag.Int64Var(&deployStartTimestamp, "deploy-start-time", getEnvInt("DEPLOY_START", time.Now().UnixNano()), "unix timestamp with nanoseconds, specifies when NAIS deploy of contests started")
